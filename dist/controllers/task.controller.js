...
exports.deleteTask = exports.updateTaskStatus = exports.updateTask = exports.createTask = exports.getTasksByProject = void 0;
...
const createTask = async (req, res) => {
    try {
        const { title, description, projectId, startDate, endDate, assignedToId, status, progress, estimatedHours, actualHours, dependencies } = req.body;
